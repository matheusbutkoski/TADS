...
public class DateUtils {
    ...
    private static DateTimeFormatter formatterBD = DateTimeFormatter.ofPattern("yyyy/MM/dd");
    ...
    public static String formatarDataBD(LocalDate dt) {
        return dt.format(formatterBD);
