...
public class Input {
    ...
    public static String nextLine() {
        // o comando useDelimiter("\\n") especifica para o leitor que o delimitador será
        // a quebra de linha (\\n).
        // Desta forma o comando next() irá realizar a leitura de toda a linha digitada
        // no terminal.
    ...
    public static int nextInt() {
        while (true) { // laço de repetição infinito (para garantir que só irá sair da função após a
                       // leitura de um número válido)
            String valor = "";

            // trecho de código que pode vir a gerar (lançar) uma exceção. Veja mais em:
            // https://www.devmedia.com.br/tratando-excecoes-em-java/25514
            try {
                // realiza a leitura do teclado e armazena na variável valor do tipo String
                // (texto).
                valor = leitor.next();

                // converte o valor que está no formato String (texto) para o formato int.
                // Se o processo de conversão for realizado com sucesso, o valor inteiro será
                // retornado. Caso, haja um problema na conversão, será lancada um Exceção
                // (Exception).
                return Integer.parseInt(valor);
            } catch (NumberFormatException e) { // A exceção do tipo NumberFormatException é capturada e tratada neste
                                                // bloco de código
                // Quando a exceção do tipo NumberFormatException for gerada, a função irá
                // informar o usuário e solicitar que seja digitado um valor novamente.
