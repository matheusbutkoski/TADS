...
public static double arredonda(double valor, int casasDecimais) {
    ...
    public static ArrayList<Integer> ordenarLista(ArrayList<Integer> numeros, boolean ordemCrescente) {
        if (ordemCrescente) {
    ...
    public static int menorValor(ArrayList<Integer> l){
        if (l == null || l.isEmpty()) {
    ...
    public static int maiorValor(ArrayList<Integer> l){
        if (l == null || l.isEmpty()) {
    ...
    public static double mediaValores(ArrayList<Integer> l){
        double soma = 0;
        double media = 0;
    ...
    public static double medianaValores(ArrayList <Integer> valores){
        ...
        if(valores.size()%2==0){
            ...
            int pos2 = (int) Math.floor(valores.size()/2);
            return valores.get(pos2);
        }
    }
    ...
    public static String formatarValorMoeda(double valor, int casasDecimais){
         NumberFormat moeda = NumberFormat.getCurrencyInstance();
         moeda.setMaximumFractionDigits(casasDecimais);
         moeda.setMaximumFractionDigits(casasDecimais);
