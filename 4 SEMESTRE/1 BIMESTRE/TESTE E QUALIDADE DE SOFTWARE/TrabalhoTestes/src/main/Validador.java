...
double mediaFinal;
    ...
    public boolean somenteNumeros(String str) {
        return str != null && str.trim().matches("[0-9]*") && str.trim() != "";
  ...
  public boolean cpfValido(String cpf) {
        ...
        try {
            ...
            if ((resultado == 10) || (resultado == 11)) {
                ...
                digito11 = (char) (resultado + 48); // ERRO PRECISA SER 48
            }
    ...
    public double fecharNotas(double nota1, double nota2){
       return mediaFinal = (nota1 + nota2) / 2;
    }
